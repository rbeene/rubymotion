class NextEventViewController < UIViewController
  ...
  def updateSignInButton
    if User.isLogged?
      @button_for_sign_in.setTitle("Logout", forState:UIControlStateNormal)
      @button_for_sign_in.removeTarget(self, action:"sign_in:", forControlEvents:UIControlEventTouchUpInside)
      @button_for_sign_in.addTarget(self, action:'sign_out:', forControlEvents:UIControlEventTouchUpInside)
    else
      @button_for_sign_in.setTitle("I have an account, sign-in to book", forState:UIControlStateNormal)
      @button_for_sign_in.removeTarget(self, action:"sign_out:", forControlEvents:UIControlEventTouchUpInside)
      @button_for_sign_in.addTarget(self, action:'sign_in:', forControlEvents:UIControlEventTouchUpInside)
    end
  end
