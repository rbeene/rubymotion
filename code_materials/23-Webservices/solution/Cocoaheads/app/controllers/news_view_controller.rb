class NewsViewController < UITableViewController
  ...
  def setupNavigationBar
    self.navigationController.navigationBar.setBackgroundImage(UIImage.imageNamed("bgNavigationBar"), 
  ...
  def load_latest_news
    ...
    News.latest_news( lambda do|news, error|  
      ...
      if error.nil?      
        ...
        p "3" 
        self.performSelectorOnMainThread("showErrorMessage:", withObject:error, waitUntilDone:false)   
